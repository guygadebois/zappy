...
/*   Updated: 2014/06/20 17:52:37 by dcouly           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (trant->direct == 0 && (trant->x - 1) >= 0)
		ft_move(map, trant, (trant->x - 1), trant->y);
	else if (trant->direct == 0 && (trant->x - 1) < 0)
		ft_move(map, trant, (game->length - 1), trant->y);
	else if (trant->direct == 1 && (trant->y + 1) == game->width)
		...
		ft_move(map, trant, (trant->x + 1), trant->y);
	else if (trant->direct == 3 && (trant->y) >= 0)
		ft_move(map, trant, trant->x, (trant->y - 1));
	else if (trant->direct == 3 && (trant->y - 1) < 0)

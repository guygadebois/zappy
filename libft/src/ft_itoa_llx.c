...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2014/04/25 17:38:35 by glourdel          #+#    #+#             */
/*   Updated: 2014/04/25 17:40:47 by glourdel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		find_digits_nbr(unsigned long long nbr)
{
	int		i;
...
static void		fill_digits(char *x_tab, char *result, unsigned long long nbr)
{
	char	buf[2];
